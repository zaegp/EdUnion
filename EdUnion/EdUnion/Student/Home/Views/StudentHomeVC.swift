...
class StudentHomeVC: BaseCollectionVC {
    
    override func viewDidLoad() {
        self.viewModel = StudentHomeViewModel()  // 使用 StudentHomeViewModel
        super.viewDidLoad()
    }
}
...
class StudentHomePageVC: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate {

    private var pageViewController: UIPageViewController!
    private let viewControllers: [UIViewController] = [FollowVC(), StudentHomeVC(), FrequentlyUsedVC()]
